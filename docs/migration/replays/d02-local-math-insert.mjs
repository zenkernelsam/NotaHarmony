...
assert.match(canvas,
  /private startMathInsert\(\): void \{\s+if \(!this\.lifecycleActive \|\| this\.mathEditorVisible \|\| this\.photoImportBusy \|\|\s+this\.historyBusy \|\|[\s\S]{0,180}this\.loadedPageId !== this\.currentPage\.pageId\) \{\s+return;\s+\}/);
