...
assert.match(repository, /originalPageIdentityExists\(store, noteId, page\.pageId\)/);
assert.match(repository, /persistOriginalPageBackground\(store, noteId, page\.pageId/);
